# _summarize_test_results - Complete PRD Documentation

## Overview
PRDs for nodes in the '_summarize_test_results' module.

## Table of Contents

- [format_test_summary](#format_test_summary)
...
**Returns:** str - Formatted summary of test execution results, including raw output wrapped in backticks and test status.
