...
class SummarizeTestResultsOutput(BaseModel):
    ...
    summary: str = (
        Field(..., description="A single paragraph that states the test outcome, includes the exact raw output wrapped in backticks, and is formatted for clear, standalone logging or display.")
    )
